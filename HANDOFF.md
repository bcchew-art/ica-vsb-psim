...
- 2026-04-14: DALL-E images wired in — tuas-overview.png replaces engineering drawing (no CSS filter), twin-zone-8.png already in place; ZONE_HOTSPOTS reduced to 7 zones (4B/5/5B/6A/7/8/9A) matching isometric cylinders; ZONE_8_EQUIPMENT_POSITIONS updated for zone close-up; ZONE_DEFINITIONS updated; img maxHeight + objectFit:contain added; build clean
